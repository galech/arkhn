...
def get_deployments_pods(deployments):
    ...
    chunks = [apps_selector[i:i + MAX_LABEL_VALUES] for i in range(0, len(apps_selector), MAX_LABEL_VALUES)]
    return [pod for chunk in chunks for pod in core_v1.list_namespaced_pod(
